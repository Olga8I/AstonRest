...
class UserToDepartmentRepositoryImplTest {
    ...
    void save() {
        ...
        Optional<UserDepartment> resultLink = userToDepartmentRepository.findById(link.getId());
    ...
    void update() {
        ...
        UserDepartment link = userToDepartmentRepository.findById(2L).get();
        ...
        UserDepartment resultLink = userToDepartmentRepository.findById(2L).get();
    ...
    void deleteById() {
        ...
        UserDepartment link = new UserDepartment(null, 1L, 3L);
        link = userToDepartmentRepository.save(link);
    ...
    void findById(Long expectedId, Boolean expectedValue, Long expectedUserId, Long expectedDepartmentId) {
        Optional<UserDepartment> link = userToDepartmentRepository.findById(expectedId);
    ...
    void findByUserIdAndDepartmentId(Long userId, Long departmentId, Boolean expectedValue) {
        Optional<UserDepartment> link = userToDepartmentRepository.findByUserIdAndDepartmentId(userId, departmentId);
