...
import org.example.servlet.DepartmentServlet;
...
class DepartmentServletTest {
    ...
    void doPost() throws IOException {
        ...
        ArgumentCaptor<DepartmentIncoming> argumentCaptor = ArgumentCaptor.forClass(DepartmentIncoming.class);
        Mockito.verify(mockDepartmentService).save(argumentCaptor.capture());

        DepartmentIncoming result = argumentCaptor.getValue();
    ...
    void doPut() throws IOException, NotFoundException {
        ...
        ArgumentCaptor<DepartmentUpdate> argumentCaptor = ArgumentCaptor.forClass(DepartmentUpdate.class);
        Mockito.verify(mockDepartmentService).update(argumentCaptor.capture());

        DepartmentUpdate result = argumentCaptor.getValue();
        Assertions.assertEquals(expectedName, result.getName());
    }
