...
class PhoneNumberServiceImplTest {
    ...
    void save() {
        ...
        PhoneNumberIncoming dto = new PhoneNumberIncoming("+123 123 1111");
        ...
        PhoneNumberOutGoing result = phoneNumberService.save(dto);
    ...
    void update() throws NotFoundException {
        ...
        PhoneNumberUpdate dto = new PhoneNumberUpdate(expectedId, "+123 123 1111", null);
    ...
    @Test
    void updateNotFound() {
        PhoneNumberUpdate dto = new PhoneNumberUpdate(1L, "+123 123 1111", null);
    ...
    void findById() throws NotFoundException {
        ...
        PhoneNumberOutGoing dto = phoneNumberService.findById(expectedId);
