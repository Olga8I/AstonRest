...
class DepartmentServiceImplTest {
    ...
    void save() {
        ...
        DepartmentIncoming dto = new DepartmentIncoming("department #2");
        ...
        DepartmentOutGoing result = departmentService.save(dto);
    ...
    void update() throws NotFoundException {
        ...
        DepartmentUpdate dto = new DepartmentUpdate(expectedId, "department update #1");
    ...
    @Test
    void updateNotFound() {
        DepartmentUpdate dto = new DepartmentUpdate(1L, "department update #1");
    ...
    void findById() throws NotFoundException {
        ...
        DepartmentOutGoing dto = departmentService.findById(expectedId);
    ...
    void deleteUserFromDepartment() throws NotFoundException {
        Long expectedId = 100L;
        Optional<UserDepartment> link = Optional.of(new UserDepartment(expectedId, 1L, 2L));
    ...
    void addUserToDepartment() throws NotFoundException {
        ...
        ArgumentCaptor<UserDepartment> argumentCaptor = ArgumentCaptor.forClass(UserDepartment.class);
        Mockito.verify(mockUserToDepartmentRepository).save(argumentCaptor.capture());
        UserDepartment result = argumentCaptor.getValue();
