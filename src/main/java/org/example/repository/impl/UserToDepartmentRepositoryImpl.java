...
public class UserToDepartmentRepositoryImpl implements UserToDepartmentRepository {
    ...
    private static UserDepartment createUserDepartament(ResultSet resultSet) throws SQLException {
        UserDepartment userToDepartment;
        userToDepartment = new UserDepartment(
    ...
    @Override
    public UserDepartment save(UserDepartment userToDepartment) {
    ...
    @Override
    public void update(UserDepartment userToDepartment) {
        try (Connection connection = connectionManager.getConnection();
    ...
    public Optional<UserDepartment> findById(Long id) {
        UserDepartment userToDepartment = null;
        try (Connection connection = connectionManager.getConnection();
            ...
            if (resultSet.next()) {
                userToDepartment = createUserDepartament(resultSet);
            }
        } catch (SQLException e) {
            throw new RepositoryException(e);
        }
    ...
    public List<UserDepartment> findAll() {
        List<UserDepartment> userToDepartmentList = new ArrayList<>();
        try (Connection connection = connectionManager.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(FIND_ALL_SQL)) {

            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                userToDepartmentList.add(createUserDepartament(resultSet));
            }
        } catch (SQLException e) {
            throw new RepositoryException(e);
        }
    ...
    public List<UserDepartment> findAllByUserId(Long userId) {
        ...
        try (Connection connection = connectionManager.getConnection();
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                userDepartmentList.add(createUserDepartament(resultSet));
            }
        } catch (SQLException e) {
            throw new RepositoryException(e);
        }
    ...
    public List<UserDepartment> findAllByDepartmentId(Long departmentId) {
        List<UserDepartment> userDepartmentList = new ArrayList<>();
        try (Connection connection = connectionManager.getConnection();
    ...
    @Override
    public Optional<UserDepartment> findByUserIdAndDepartmentId(Long userId, Long departmentId) {
        Optional<UserDepartment> userDepartment = Optional.empty();
        try (Connection connection = connectionManager.getConnection();
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            if (resultSet.next()) {
                userDepartment = Optional.of(createUserDepartament(resultSet));
            }
        } catch (SQLException e) {
            throw new RepositoryException(e);
        }
