...
public class DepartmentServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            if ("all".equals(pathPart[1])) {
                List<DepartmentOutGoing> departmentDtoList = departmentService.findAll();
                resp.setStatus(HttpServletResponse.SC_OK);
                responseAnswer = objectMapper.writeValueAsString(departmentDtoList);
            } else {
                Long departmentId = Long.parseLong(pathPart[1]);
                DepartmentOutGoing departmentDto = departmentService.findById(departmentId);
                resp.setStatus(HttpServletResponse.SC_OK);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Optional<DepartmentIncoming> departmentResponse;
        try {
            departmentResponse = Optional.ofNullable(objectMapper.readValue(json, DepartmentIncoming.class));
            DepartmentIncoming department = departmentResponse.orElseThrow(IllegalArgumentException::new);
    ...
    public void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        String responseAnswer = "";
        Optional<DepartmentUpdate> departmentResponse;
        try {
            if (req.getPathInfo().contains("/addUser/")) {
                ...
                departmentResponse = Optional.ofNullable(objectMapper.readValue(json, DepartmentUpdate.class));
                DepartmentUpdate departmentUpdateDto = departmentResponse.orElseThrow(IllegalArgumentException::new);
